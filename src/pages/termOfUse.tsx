...
const TermOfUse = () => {
  return (
    <Container>
      ...
      <p>
        이 약관은 댕댕로드 사이트에서 제공하는 인터넷서비스(이하 "서비스"라
        합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로
        합니다.
      </p>

      <Heading>제 2 조 (약관의 효력 및 변경)</Heading>
      <p>
        ① 이 약관은 서비스 화면이나 기타의 방법으로 이용고객에게 공지함으로써
        효력을 발생합니다. <br />② 사이트는 이 약관의 내용을 변경할 수 있으며,
        변경된 약관은 제1항과 같은 방법으로 공지 또는 통지함으로써 효력을
        발생합니다.
      </p>

      <Heading>제 3 조 (용어의 정의)</Heading>
      <p>
        ...
        <br />
        ③ 아이디(ID): 회원의 식별과 서비스 이용을 위하여 회원이 정하고 사이트가
      ...
      <Title>제 2 장 서비스 이용계약</Title>
      <Heading>제 4 조 (이용계약의 성립)</Heading>
      <p>
        ① 이용약관 하단의 동의 버튼을 누르면 이 약관에 동의하는 것으로
        간주됩니다. <br />② 이용계약은 서비스 이용희망자의 이용약관 동의 후 이용
        신청에 대하여 사이트가 승낙함으로써 성립합니다.
      </p>
      <Heading>제 5 조 (이용신청)</Heading>
      <p>
        ① 신청자가 본 서비스를 이용하기 위해서는 사이트 소정의 가입신청 양식에서
        요구하는 이용자 정보를 기록하여 제출해야 합니다. <br />② 가입신청 양식에
        기재하는 모든 이용자 정보는 모두 실제 데이터인 것으로 간주됩니다.
        실명이나 실제 정보를 입력하지 않은 사용자는 법적인 보호를 받을 수
        없으며, 서비스의 제한을 받을 수 있습니다.
      </p>
      <Heading>제 6 조 (이용신청의 승낙)</Heading>
      <p>
      ...
      <Heading>제 7 조 (이용자정보의 변경)</Heading>
      <p>
        회원은 이용 신청시에 기재했던 회원정보가 변경되었을 경우에는, 온라인으로
        수정하여야 하며 변경하지 않음으로 인하여 발생되는 모든 문제의 책임은
        회원에게 있습니다.
      </p>
      <Title>제 3 장 계약 당사자의 의무</Title>
      <Heading>제 8 조 (사이트의 의무)</Heading>
      <p>
        ...
        이외의 상업적 목적으로 사용할 수 없습니다. 단, 다음 각 호의 1에 해당하는
        경우는 예외입니다.
        <br />
      ...
      <p>
        ...
        바. 기타 관계법령에 위배되는 행위
        <br />
        ② 회원은 관계법령, 이 약관에서 규정하는 사항, 서비스 이용 안내 및 주의
        사항을 준수하여야 합니다.
        <br />
      ...
      <Heading>제 11 조 (서비스 제한 및 정지)</Heading>
      <p>
      ...
      <Title>제5장 계약사항의 변경, 해지</Title>
      <Heading>제 12 조 (정보의 변경)</Heading>
      <p>
        회원이 주소, 비밀번호 등 고객정보를 변경하고자 하는 경우에는 홈페이지의
        회원정보 변경 서비스를 이용하여 변경할 수 있습니다.
      </p>
      <Heading>제 13 조 (계약사항의 해지)</Heading>
      <p>
      ...
      <Title>제6장 손해배상</Title>
      <Heading>제 14 조 (면책조항)</Heading>
      <p>
        ...
        면제됩니다.
        <br />
        ④ 상표권이 있는 도메인의 경우, 이로 인해 발생할 수도 있는 손해나 배상에
        대한 책임은 구매한 회원 당사자에게 있으며, 사이트는 이에 대한 일체의
        책임을 지지 않습니다.
        <br />
      </p>
      <Heading> 제 15 조 (관할법원)</Heading>
      ...
      <p>(시행일) 이 약관은 2021년 3월부터 시행합니다.</p>
    </Container>
  );
};
